...
public class OttawaServerImpl1 extends ClientServerInterfacePOA implements Runnable  {
	...
	public static OttawaServerImpl1 add;

	public OttawaServerImpl1()  {
		super();
	}
	...
	{
		String Path1 = "LogServer/" + "OttawaServerImpl1Log.txt";
		try {
	...
	/*		OttawaServerImpl1 add = new OttawaServerImpl1();
			Registry reg = LocateRegistry.createRegistry(7181);
			String url = "rmi://localhost:7181";

			reg.rebind(url, add);
*/
			add = new OttawaServerImpl1();
			
		     	add.addEvent("C", "OTWM000000", 1);
		        add.addEvent("S", "OTWM000000", 1);
		        add.addEvent("T", "OTWM000000", 1);
		
			Thread threadSocket = new Thread(new OttawaServerImpl1());
			threadSocket.start();
			...
			try
			{
				socket = new DatagramSocket(6171);
	...
	public void run() {
		...
		try {
			...
			socket = new DatagramSocket(7181);
