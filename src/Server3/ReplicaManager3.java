...
public class ReplicaManager3  {
	...
	public static MontrealServerImpl mtlserver;
	public static OttawaServerImpl otwserver;
	public static TorontoServerImpl torserver;
	public static ReplicaManager3 add;
	...
	{
		String Path1 = "LogServer/" + "ReplicaManager3Log.txt";
		try {
	...
	public static void main(String args[]) throws IOException {
		...
		add = new ReplicaManager3();
		System.out.println("############ ReplicaMansager3 started #############");
		startReplicaManager();
